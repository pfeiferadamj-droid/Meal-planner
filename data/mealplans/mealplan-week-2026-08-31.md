...
Plain Midwest weeknight dinners: baked salmon with potatoes, a cheesy chicken and rice bake, taco night, sloppy joes, and fried rice. Every meal is gluten-free and leans low-sodium. **Zero red-meat dinners this week** — beef, pork, and lamb sit out entirely as requested. No lentils, no artichokes, no yogurt-based sauces, no frozen entrées. **One Asian dinner (Chicken Fried Rice) and no Indian**, per the cuisine mix in `data/diner-preferences.md`. The egg in the fried rice is bound into the dish, not the featured protein. No meal repeats from the last two weeks. Fearless Flyer was not consulted at planning time, so every product comes from the verified catalog in `data/data_context.md`.
...
**On the protein mix:** with no red meat, no turkey, no tofu, and fish limited to the one swap night, chicken carries four of the five dinners. They're deliberately different cuts and techniques (baked thighs, pulled chicken, ground chicken, diced breast), and black beans do real protein work on taco night. Say the word if you'd rather one night go vegetarian — chili or baked potatoes would slot in cleanly.
...
```json
{
  ...
  "meals": [
    ...
    {
      "type": "Dinner",
      "name": "Sloppy Joes with Coleslaw",
      "build": {
        "pro": ["ground chicken, browned"],
        "base": ["Trader Joe's Gluten Free Whole Grain Bread, toasted"],
        "veg": ["yellow onions", "Trader Joe's Cruciferous Crunch Collection"],
      ...
      "ingredients": [
        ...
        { "name": "Trader Joe's Gluten Free Whole Grain Bread", "quantity": "2 slices, toasted (open-faced)", "category": "base", "macros": { "cal": 160, "p": 4, "c": 28, "f": 3, "fiber": 4 } },
        { "name": "Yellow onions", "quantity": "1/2 cup diced", "category": "veg", "macros": { "cal": 30, "p": 1, "c": 7, "f": 0, "fiber": 1 } },
        { "name": "Trader Joe's Cruciferous Crunch Collection", "quantity": "1 1/2 cups, dressed with cider vinegar", "category": "veg", "macros": { "cal": 45, "p": 3, "c": 8, "f": 0, "fiber": 3 } },
        { "name": "Trader Joe's Kansas City Style BBQ Sauce", "quantity": "2 tbsp", "category": "engine", "macros": { "cal": 70, "p": 0, "c": 17, "f": 0, "fiber": 0 } }
      ],
      "macros": { "cal": 525, "p": 38, "c": 60, "f": 14, "fiber": 8 }
    },
    {
      "type": "Dinner",
